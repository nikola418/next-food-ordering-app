    ...
    const handleCreate = async () => {
        ...
        try {
            const uploadRes = await axios.post(
                "https://api.cloudinary.com/v1_1/dv2i8zgqy/image/upload",
                data
            )
    ...
    return (
        <div className={styles.container}>
            <div className={styles.wrapper}>
                ...
                <div className={styles.item}>
                    <label htmlFor="" className={styles.label}>Desc</label>
                ...
                <div className={styles.item}>
                    <label htmlFor="" className={styles.label}>Extras</label>
                    <div className={styles.extrasContainer}>
                        ...
                        <input 
                            ...
                            onChange={handleExtra}
                            />
                        <button className={styles.extraButton} onClick={handleExtras}>Add</button>
                    </div>
                    <div className={styles.extraItems}>
                        {extraOptions.map((option) => (
                            <span className={styles.extraItem} key={option.text}>{option.text} - ${option.price}</span>
                            ))}
                    </div>
                </div>
